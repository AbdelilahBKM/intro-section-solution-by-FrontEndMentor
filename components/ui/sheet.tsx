...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), className) + " bg-background"}
      {...props}
    >
      {children}
      <SheetPrimitive.Close className="absolute border-0 right-6 top-6">
        <Image  src={'/images/icon-close-menu.svg'} width={35} height={35} alt="close menu"/>
